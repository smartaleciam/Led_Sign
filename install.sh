...
#    git clone https://smartaleciam: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@github.com/smartalecim/Led_Sign.git sign
gh repo clone smartaleciam/Led_Sign sign
    cd sign
